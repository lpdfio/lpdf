...
$section1 = Kit::section(
    nodes: [
        Kit::canvas([
            Canvas::layer([

                // ── Heading bar ──────────────────────────────────────────────────────
                Canvas::rect(0, 0, 595, 60, new RectStyle(fill: '#1a3a5c')),
                ...
                // ── Section: rect ────────────────────────────────────────────────────
                Canvas::text(28, 80, 'canvas-rect', new TextStyle(font: 'Helvetica-Bold', size: 11, color: '#555555')),

                // Plain fill
                Canvas::rect(28, 96, 120, 60, new RectStyle(fill: '#4a90e2')),

                // Fill + stroke
                Canvas::rect(164, 96, 120, 60, new RectStyle(
                    fill: '#e8f4fd', stroke: '#2980b9', strokeWidth: 2,
                )),

                // Rounded corners
                Canvas::rect(300, 96, 120, 60, new RectStyle(
                    fill: '#d5f5e3', stroke: '#27ae60', strokeWidth: 1, borderRadius: 12,
                )),

                // Stroke only
                Canvas::rect(436, 96, 120, 60, new RectStyle(
                    stroke: '#e74c3c', strokeWidth: 3,
                )),

                // ── Section: line ────────────────────────────────────────────────────
                Canvas::text(28, 176, 'canvas-line', new TextStyle(font: 'Helvetica-Bold', size: 11, color: '#555555')),
                ...
                // Diagonal
                Canvas::line(340, 192, 567, 240, new LineStyle(stroke: '#16a085', strokeWidth: 2)),

                // ── Section: ellipse / circle ────────────────────────────────────────
                Canvas::text(28, 256, 'canvas-ellipse / canvas-circle', new TextStyle(font: 'Helvetica-Bold', size: 11, color: '#555555')),

                // Ellipse filled
                Canvas::ellipse(100, 305, 72, 40, new EllipseStyle(fill: '#f39c12', stroke: '#d68910', strokeWidth: 2)),

                // Circle filled
                Canvas::circle(260, 305, 40, new EllipseStyle(fill: '#27ae60')),

                // Circle stroke only
                Canvas::circle(380, 305, 40, new EllipseStyle(stroke: '#c0392b', strokeWidth: 3)),

                // Ellipse no fill, dashed stroke
                Canvas::ellipse(490, 305, 65, 35, new EllipseStyle(stroke: '#2c3e50', strokeWidth: 1, strokeDash: [4, 2])),

                // ── Section: path ────────────────────────────────────────────────────
                Canvas::text(28, 356, 'canvas-path', new TextStyle(font: 'Helvetica-Bold', size: 11, color: '#555555')),
                ...
                // ── Section: text ────────────────────────────────────────────────────
                Canvas::text(28, 436, 'canvas-text', new TextStyle(font: 'Helvetica-Bold', size: 11, color: '#555555')),

                // Left-aligned (default)
                Canvas::text(28, 454, 'Left-aligned text (Helvetica 12)', new TextStyle(font: 'Helvetica', size: 12, color: '#222222')),
                ...
                // Custom font
                Canvas::text(28, 518, 'Montserrat Regular — custom TTF font', new TextStyle(
                ...
                // ── Section: layer ───────────────────────────────────────────────────
                Canvas::text(28, 570, 'canvas-layer', new TextStyle(font: 'Helvetica-Bold', size: 11, color: '#555555')),

                // Background for the layer demo
                Canvas::rect(28, 586, 539, 80, new RectStyle(fill: '#eaf2ff', stroke: '#aed6f1', strokeWidth: 1)),
                Canvas::text(38, 596, 'Background text (behind semi-transparent layer)', new TextStyle(font: 'Helvetica', size: 10, color: '#999999')),

                // Labels for sub-demos (drawn in the base layer)
                Canvas::text(28, 680, 'Layer with clip rect:', new TextStyle(font: 'Helvetica-Bold', size: 11, color: '#555555')),
                Canvas::text(260, 680, 'Layer with transform (rotate 15°):', new TextStyle(font: 'Helvetica-Bold', size: 11, color: '#555555')),

                // ── Footer rule ──────────────────────────────────────────────────────
                Canvas::line(28, 808, 567, 808, new LineStyle(stroke: '#cccccc', strokeWidth: 0.5)),
                Canvas::text(28, 818, 'generated with lpdf.io', new TextStyle(font: 'Helvetica', size: 9, color: '#aaaaaa')),
            ...
            Canvas::layer(
                nodes: [
                    Canvas::rect(28, 586, 539, 80, new RectStyle(fill: '#e74c3c')),
                    Canvas::text(38, 614, 'Layer at 40% opacity', new TextStyle(font: 'Helvetica-Bold', size: 14, color: '#ffffff')),
                ],
            ...
            Canvas::layer(
                nodes: [
                    Canvas::rect(28, 696, 200, 80, new RectStyle(fill: '#f9e79f', stroke: '#f1c40f', strokeWidth: 2)),
                    Canvas::ellipse(128, 736, 90, 30, new EllipseStyle(fill: '#f39c12')),
                ],
            ...
            Canvas::layer(
                nodes: [
                    Canvas::rect(0, 0, 120, 40, new RectStyle(fill: '#d7bde2', stroke: '#8e44ad', strokeWidth: 1, borderRadius: 6)),
                    Canvas::text(8, 12, 'Rotated layer', new TextStyle(font: 'Helvetica', size: 11, color: '#4a235a')),
                ],
